...
<html>
    ...
    <body>
        ...
        <!-- // experimental works version 2 FINAL \\ -->
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            ...
            <?php 
                ...
                echo "<ol class='sortablemenaaaaa'>";
                foreach( $menuorder as $key => $val) {
                    $plues = $key;
                            ...
                            if( $x == 1){
                                ...
                                if($flaging==1){
                                    ...
                                    if($plues != (sizeof($levelnext)-1) && $levelnext[$plues+1] > $val['levels']) {
                                        ...
                                        if($loop < 1)
                                            $flaging=1;
                                        else if ((sizeof($levelnext)-1) && $levelnext[$plues+1] == 0)
                                            $loop=0;
                                    }
                                }
                            }
        ...
        <div id="menu" class="wrapper">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                <ol class="sortablemenu ui-sortable mjs-nestedSortable-branch mjs-nestedSortable-expanded">
                <?php 
                    foreach ($menuorder as $key => $val) :
                ?>
                    <li class="mjs-nestedSortable-leaf" id="menuItem_<?php echo $val['id']; ?>">
                       <div class="checkme" id="<?php echo $val['menu']; ?>">
                           <?php echo $val['menu']; ?>
                       </div>
                   </li>
                <?php
